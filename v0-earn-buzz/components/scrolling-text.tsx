...
const messages = [
  ...
  "🌟 Join thousands earning daily on Moneymate 9ja!",
  ...
  "💥 Moneymate 9ja - Where referrals pay big!",
  ...
  "🏆 Moneymate 9ja - Home of top earners!",
  ...
  "🚀 It’s not luck – it’s Moneymate 9ja!",
];
...
export function ScrollingText() {
  ...
  // Signup-green strip (matches app color).
  return (
