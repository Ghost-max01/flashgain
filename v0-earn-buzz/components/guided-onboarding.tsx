...
const STEPS: Step[] = [
  ...
  { id: "trust", title: "Trust Score", desc: "Earn: 5 mins +2, 1 referral +1, 10 navs +1, 10 tasks +2, 20 taps +1, payment +10.", target: '[data-tour="trust"]', icon: Award, color: "from-blue-500 to-violet-600" },
  ...
  { id: "playwin", title: "Spin & Win", desc: "Stake & Spin wheel — live pool + 30% win.", target: '[data-tour="play-win"]', icon: Gift, color: "from-amber-500 to-emerald-600" },
