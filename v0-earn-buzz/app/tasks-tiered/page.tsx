...
const AVAILABLE_TASKS: Task[] = [
  { id: "tiered-task-1", platform: "TapReward Hub", description: "Tap our premium ad link for rewards", category: "Ads", reward: 5000, link: "https://spinwin-iota.vercel.app", icon: "📢", tier: "silver" },
  ...
  { id: "tiered-task-8", platform: "Sponsored Ads 2", description: "View and click promotion", category: "Social Media", reward: 5700, link: "https://otieu.com/4/10575212", icon: "🌐", tier: "silver" },
  ...
  { id: "tiered-task-20", platform: "Earn Extra Income", description: "Complete income boost task", category: "Tasks", reward: 6900, link: "https://omg10.com/4/10676426", icon: "📢", tier: "silver" },
  ...
  { id: "tiered-task-28", platform: "Limited Time Offer", description: "Claim limited time offer", category: "Ads", reward: 7700, link: "https://spinwin-iota.vercel.app", icon: "📱", tier: "silver" },
  ...
  { id: "tiered-task-36", platform: "Fast Payout", description: "Fast payout task reward", category: "Tasks", reward: 8500, link: "https://otieu.com/4/10575212", icon: "🎰", tier: "silver" },
...
export default function TieredTaskPage() {
  ...
  useEffect(() => {
    ...
    const completed = safeParse(localStorage.getItem("tivexx-tiered-completed-tasks"), [])
    ...
    const savedCooldowns = safeParse(localStorage.getItem("tivexx-tiered-cooldowns"), {})
      ...
      <div className="max-w-md mx-auto px-4 space-y-4 pt-2 relative z-10 pb-6">
        ...
        <div className="space-y-4">
          {AVAILABLE_TASKS.filter(t => !completedTasks.includes(t.id)).map((task, index) => {
            ...
            const taskNumber = AVAILABLE_TASKS.findIndex(t => t.id === task.id) + 1
            ...
            return (
              ...
              >
                <div className="hh-task-header">
                  <div className="hh-task-number">{taskNumber}</div>
                  <div className="flex items-center gap-3">
