      ...
      <div className="sticky top-0 z-10 hh-header">
        <div className="max-w-md mx-auto px-6 pt-8 pb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="hh-title">MU Tasks</h1>
              <p className="hh-subtitle">{needParam>0 ? `Showing ${displayTasks.length} of ${AVAILABLE_TASKS.length} tasks` : "Complete tasks & earn rewards"}</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="relative z-10">
            ...
            <div className="hh-stats-row mt-4">
              <div className="hh-stat-item">
                ...
                <div className="hh-stat-value text-emerald-400">{displayTasks.length - completedTasks.filter(id=>displayTasks.some(dt=>dt.id===id)).length}</div>
              </div>
              <div className="hh-stat-divider"></div>
              <div className="hh-stat-item">
                <div className="hh-stat-label">Completed</div>
                <div className="hh-stat-value text-amber-300">{completedTasks.filter(id=>displayTasks.some(dt=>dt.id===id)).length}</div>
              </div>
            </div>
          </div>
        </div>
