...
export default function DashboardPage() {
  ...
  const formatCurrency = (amount: number) => {
    if (!showBalance) {
      return (
        <span className="tracking-widest flex items-center gap-1">
          {[...Array(4)].map((_, i) => (
            <span key={i} className="inline-block w-8 h-5 bg-black/10 rounded-md animate-pulse" style={{ animationDelay: `${i * 0.15}s` }}></span>
          ))}
        </span>
      )
    }
    ...
    return (
      <span className={`font-mono transition-colors duration-300 ${isBalanceChanging ? 'text-emerald-800' : 'text-[#12190f]'}`}>
      ...
      <div className="min-h-screen flex items-center justify-center bg-[#0a0e14]">
        <div className="text-center">
          <div className="relative w-16 h-16 mx-auto mb-4">
            ...
            <div className="absolute inset-2 rounded-full border-2 border-amber-400/40 animate-ping" style={{ animationDelay: '0.3s' }}></div>
          ...
          <div className="relative z-10">
            ...
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-black/55 font-medium uppercase tracking-wider">Available Balance</span>
              </div>
              <button
            ...
            <div className="hh-claim-section mt-5 relative">
              ...
              <div className="flex items-center justify-between mt-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  {claimCount >= 50 && <span className="text-xs text-amber-300 animate-pulse">🔥 Max</span>}
                </div>
              </div>
            </div>
            ...
            <div className="hh-stats-row mt-4">
              ...
              <div className="hh-stat-item">
                ...
                <div className="hh-stat-value text-amber-300">{Math.max(0, 50 - claimCount)} remaining</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="hh-card hh-entry-4">
          ...
          <div className="space-y-3 mt-3">
            ...
            <Link href="/earn/tap" className="block focus:outline-none">
              <button className="w-full hh-action-btn hh-action-tap" style={{ animationDelay: '660ms' }}>
                <span className="hh-action-icon">🎮</span>
      ...
      <style jsx global>{`
        ...
        */
        :root {
          ...
          --hh-glass-border: rgba(255,255,255,0.10);
        }
        ...
        .hh-root {
          ...
          background:
            radial-gradient(ellipse 700px 420px at 12% 0%, rgba(46,204,143,0.13), transparent 60%),
            radial-gradient(ellipse 700px 420px at 100% 12%, rgba(224,168,56,0.10), transparent 55%),
            linear-gradient(160deg, var(--hh-bg-1) 0%, var(--hh-bg-2) 45%, var(--hh-bg-3) 100%);
        ...
        .hh-bubble-1  { width: 8px; height: 8px; left: 10%; background: radial-gradient(circle, rgba(46,204,143,0.6), transparent); animation-duration: 8s; animation-delay: 0s; }
        .hh-bubble-2  { width: 14px; height: 14px; left: 25%; background: radial-gradient(circle, rgba(245,215,110,0.5), transparent); animation-duration: 11s; animation-delay: 1.5s; }
        .hh-bubble-3  { width: 6px; height: 6px; left: 40%; background: radial-gradient(circle, rgba(46,204,143,0.7), transparent); animation-duration: 9s; animation-delay: 3s; }
        .hh-bubble-4  { width: 18px; height: 18px; left: 55%; background: radial-gradient(circle, rgba(224,168,56,0.4), transparent); animation-duration: 13s; animation-delay: 0.5s; }
        .hh-bubble-5  { width: 10px; height: 10px; left: 70%; background: radial-gradient(circle, rgba(46,204,143,0.5), transparent); animation-duration: 10s; animation-delay: 2s; }
        ...
        .hh-bubble-7  { width: 12px; height: 12px; left: 15%; background: radial-gradient(circle, rgba(245,215,110,0.4), transparent); animation-duration: 12s; animation-delay: 5s; }
        .hh-bubble-8  { width: 7px; height: 7px; left: 35%; background: radial-gradient(circle, rgba(46,204,143,0.6), transparent); animation-duration: 9.5s; animation-delay: 2.5s; }
        .hh-bubble-9  { width: 20px; height: 20px; left: 60%; background: radial-gradient(circle, rgba(46,204,143,0.2), transparent); animation-duration: 15s; animation-delay: 1s; }
        .hh-bubble-10 { width: 9px; height: 9px; left: 88%; background: radial-gradient(circle, rgba(224,168,56,0.5), transparent); animation-duration: 10.5s; animation-delay: 6s; }
        ...
        .hh-bubble-12 { width: 16px; height: 16px; left: 48%; background: radial-gradient(circle, rgba(245,215,110,0.3), transparent); animation-duration: 14s; animation-delay: 7s; }
        ...
        .hh-mesh-overlay {
          ...
          inset: 0;
          background:
            radial-gradient(ellipse 60% 40% at 20% 80%, rgba(46,204,143,0.08) 0%, transparent 60%),
            radial-gradient(ellipse 50% 50% at 80% 20%, rgba(224,168,56,0.07) 0%, transparent 60%),
            radial-gradient(ellipse 40% 30% at 50% 50%, rgba(46,204,143,0.04) 0%, transparent 60%);
          pointer-events: none;
          z-index: 0;
        }
        ...
        .hh-beam-overlay {
          position: fixed;
          inset: -10% -20%;
          background: linear-gradient(100deg, transparent 42%, rgba(255,255,255,0.035) 50%, transparent 58%);
        ...
        .hh-card:hover {
          ...
          box-shadow: 0 20px 60px rgba(0,0,0,0.4), 0 0 30px rgba(46,204,143,0.08), inset 0 1px 0 rgba(255,255,255,0.08);
        }
        ...
        .hh-card::before {
          ...
          height: 2px;
          background: linear-gradient(90deg, var(--hh-green-1), var(--hh-gold-1));
          opacity: 0.55;
        }
        ...
        .hh-card-balance {
          background: linear-gradient(115deg, #33c98f 0%, #46c78f 26%, #9dcf7f 50%, #e3c869 74%, #eec95a 100%);
          border-color: rgba(255,255,255,0.25);
          box-shadow: 0 10px 34px rgba(46,204,143,0.18), inset 0 1px 0 rgba(255,255,255,0.25);
          padding: 20px 22px;
        }

        .hh-card-balance::before {
          background: linear-gradient(90deg, rgba(18,25,15,0.25), rgba(18,25,15,0.05));
          opacity: 1;
          height: 1px;
        }
        ...
        .hh-orb-2 {
          ...
          background: radial-gradient(circle, rgba(18,25,15,0.15), transparent);
        ...
        @keyframes hh-ring-spin {
          0%   { background: linear-gradient(135deg, #2ecc8f, #f5d76e, #22b57d); }
          50%  { background: linear-gradient(135deg, #f5d76e, #22b57d, #2ecc8f); }
          100% { background: linear-gradient(135deg, #2ecc8f, #f5d76e, #22b57d); }
        }
        ...
        .hh-action-tap {
          ...
          color: var(--hh-text-dark);
          box-shadow: 0 0 20px rgba(245,215,110,0.3), 0 0 20px rgba(46,204,143,0.25);
        }
        ...
        .hh-live-dot {
          ...
          border-radius: 50%;
          background: #0d3324;
          box-shadow: 0 0 0 2px rgba(13,51,36,0.25), 0 0 8px rgba(13,51,36,0.4);
        ...
        .hh-eye-btn:hover  { background: rgba(18,25,15,0.22); transform: scale(1.05); }
        ...
        @keyframes hh-balance-flash {
          0%   { text-shadow: none; }
          50%  { text-shadow: 0 0 16px rgba(18,25,15,0.25); }
        ...
        .hh-claim-ready {
          background: linear-gradient(90deg, #2ecc8f, #f5d76e);
          color: var(--hh-text-dark);
          box-shadow: 0 0 22px rgba(245,215,110,0.45), 0 0 22px rgba(46,204,143,0.3);
          animation: hh-claim-glow 2s ease-in-out infinite;
        }

        @keyframes hh-claim-glow {
          0%, 100% { box-shadow: 0 0 22px rgba(245,215,110,0.45), 0 0 22px rgba(46,204,143,0.3); }
          50%       { box-shadow: 0 0 34px rgba(245,215,110,0.6), 0 0 34px rgba(46,204,143,0.4); }
        }
        ...
        .hh-claim-paused {
          background: linear-gradient(135deg, rgba(224,168,56,0.3), rgba(224,168,56,0.15));
        ...
        .hh-claim-success-popup {
          ...
          padding: 16px 24px;
          text-align: center;
          box-shadow: 0 20px 60px rgba(0,0,0,0.5), 0 0 30px rgba(46,204,143,0.2);
          min-width: 160px;
        ...
        .hh-confetti-1 { top: 5px; left: 20%; background: #f5d76e; animation-delay: 0s; }
        .hh-confetti-2 { top: 5px; left: 40%; background: #2ecc8f; animation-delay: 0.1s; }
        .hh-confetti-3 { top: 5px; left: 60%; background: #e0a838; animation-delay: 0.05s; }
        .hh-confetti-4 { top: 5px; left: 75%; background: #34d399; animation-delay: 0.15s; }
        .hh-confetti-5 { top: 5px; left: 10%; background: #f5d76e; animation-delay: 0.2s; }
        ...
        .hh-stat-divider { width: 1px; height: 32px; background: rgba(255,255,255,0.1); }
        .hh-stat-label { font-size: 11px; color: rgba(241,243,245,0.55); font-weight: 500; }
        ...
        .hh-action-card::before {
          ...
          position: absolute;
          inset: 0;
          background: linear-gradient(135deg, rgba(46,204,143,0.08), rgba(245,215,110,0.06));
          opacity: 0;
        ...
        .hh-action-card:hover {
          ...
          box-shadow: 0 12px 30px rgba(0,0,0,0.3), 0 0 20px rgba(46,204,143,0.08);
        }
        ...
        .hh-action-card-icon {
          ...
          align-items: center;
          justify-content: center;
          background: radial-gradient(circle at 40% 35%, rgba(255,255,255,0.06), rgba(0,0,0,0.25));
          border: 1.5px solid var(--hh-green-1);
          box-shadow: 0 0 14px rgba(46,204,143,0.45), inset 0 0 10px rgba(46,204,143,0.2);
          margin-bottom: 2px;
        }
        ...
        .hh-action-grid > *:nth-child(even) .hh-action-card-icon {
          ...
          box-shadow: 0 0 14px rgba(245,215,110,0.45), inset 0 0 10px rgba(245,215,110,0.2);
        }
        ...
        .hh-support-blue  { background: linear-gradient(135deg, #e0a838, #b9822a); box-shadow: 0 4px 12px rgba(224,168,56,0.3); }
        .hh-support-green { background: linear-gradient(135deg, #2ecc8f, #22b57d); box-shadow: 0 4px 12px rgba(46,204,143,0.3); }
        ...
        .hh-tx-credit { background: rgba(46,204,143,0.15); color: var(--hh-green-1); border: 1px solid rgba(46,204,143,0.2); }
        .hh-tx-debit  { background: rgba(224,168,56,0.15); color: var(--hh-gold-1); border: 1px solid rgba(224,168,56,0.2); }
        ...
        .hh-floating-chat-btn {
          ...
          justify-content: center;
          cursor: pointer;
          box-shadow: 0 4px 20px rgba(46,204,143,0.4), 0 4px 20px rgba(245,215,110,0.25);
          transition: all 0.3s ease;
          z-index: 35;
        }
        ...
        .hh-floating-chat-btn:hover {
          transform: scale(1.1);
          box-shadow: 0 6px 30px rgba(46,204,143,0.55), 0 6px 30px rgba(245,215,110,0.35);
        }
        ...
        .hh-nav-item:hover  { color: var(--hh-green-1); transform: translateY(-2px); }

        .hh-nav-active      { color: #ffffff !important; }
        .hh-nav-active svg  { filter: drop-shadow(0 0 6px rgba(46,204,143,0.6)); }
        .hh-nav-active::after {
          content: '';
          position: absolute;
        ...
        .hh-browser-check-popup {
          ...
          box-shadow: 0 30px 80px rgba(0,0,0,0.6), 0 0 30px rgba(46,204,143,0.1);
        ...
        .hh-browser-check-icon {
          ...
          height: 34px;
          border-radius: 10px;
          background: linear-gradient(135deg, rgba(46,204,143,0.2), rgba(46,204,143,0.05));
        ...
        .hh-browser-check-copy-btn:hover {
          box-shadow: 0 0 20px rgba(46,204,143,0.35), 0 0 20px rgba(245,215,110,0.3);
          transform: translateY(-2px);
        }
        ...
        .hh-browser-check-divider {
          height: 1px;
          background: linear-gradient(90deg, transparent, rgba(46,204,143,0.25), rgba(245,215,110,0.25), transparent);
          margin: 10px 0;
        }
