...
const AVAILABLE_TASKS: Task[] = [
  {
    id: "mt-task-01",
    platform: "MT Task 01",
    description: "Complete this link to progress your auto tap — MT.",
    category: "MT",
    reward: 2500,
    link: "https://hai8g.com/4/10571302",
    icon: "🔗",
  },
  {
    id: "mt-task-02",
  ...
  },
  {
    ...
    category: "MT",
    reward: 2500,
    link: "https://omg10.com/4/10575212",
    icon: "🔗",
  },
  {
    id: "mt-task-12",
  ...
  },
  {
    ...
    category: "MT",
    reward: 2500,
    link: "https://hai8g.com/4/10676426",
    icon: "🔗",
  },
  {
    id: "mt-task-17",
      ...
      <div className="sticky top-0 z-10 hh-header">
        <div className="max-w-md mx-auto px-6 pt-8 pb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="hh-title">MT Tasks</h1>
