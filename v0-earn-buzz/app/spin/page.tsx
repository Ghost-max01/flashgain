...
const FAQS = [
  {
    ...
    a: "Absolutely! Moneymate 9jas is an officially registered earning platform . All prizes are genuine and verifiable. Winners are contacted directly to arrange delivery.",
  },
  {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <button onClick={() => scrollTo("hero")} className="flex items-center gap-2">
            ...
            <span className="font-display font-bold text-lg bg-gradient-to-r from-amber-300 to-emerald-300 bg-clip-text text-transparent">Moneymate 9jas</span>
          </button>
      ...
      <Section id="how" className="bg-white/5">
        ...
        <div className="mt-12 max-w-2xl mx-auto card-premium rounded-xl p-6">
          ...
          <ul className="text-white/80 text-xs space-y-2 list-disc list-inside">
            ...
            <li>
              Moneymate 9jas Hub reserves the right to modify or end the promotion
              at any time.
            </li>
          </ul>
        </div>
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-white/80 mb-4 leading-relaxed">
              Moneymate 9ja is a premier promotional platform dedicated to giving
