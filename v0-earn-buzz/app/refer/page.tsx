...
import { formatCurrency } from "@/lib/utils/referral";
  import { REFERRAL_MIN_WITHDRAW, loadVip } from "@/lib/referral-vip";
...
function ReferContent() {
  ...
  // Minimum referral withdrawal is ₦10,000 (20 referrals) — no exceptions,
  // no first-₦500 path. REFERRAL_MIN_WITHDRAW is the single source of truth.
  // referral-withdraw airtime popup (10k+ only)
  ...
  // (cash + airtime) with method + destination.
  ...
  const referralMessages = [
    ...
    "I never believed online earning platforms until Moneymate9ja paid me ₦220K 💚 Click the link below to register and thank me later.",
    "Just received my ₦400K withdrawal from Moneymate9ja 💸 Click the link below and start earning.",
    "I’ve withdrawn twice already on Moneymate9ja 😭🔥 ₦200K each time. Join now with the link below.",
    "My friend introduced me to Moneymate9ja and now I’ve cashed out ₦310K. Click the link below to start.",
    "Moneymate9ja is really paying users every week 💚 I withdrew ₦280K recently. Join below 👇",
    "I used to doubt platforms like this until Moneymate9ja paid me ₦500K 💸 Click the link below to join.",
    "Imagine earning online daily and cashing out ₦230K 😭 Moneymate9ja is real. Register with the link below.",
    "I joined Moneymate9ja last month and already withdrew ₦350K 🔥 Click the link below to start.",
    "Just a reminder that Moneymate9ja has been paying consistently 💸 Join now with the link below.",
    "I completed simple tasks and withdrew ₦270K from Moneymate9ja. Click the link below and thank me later.",
    "Moneymate9ja changed my week financially 😭 I withdrew ₦450K. Register below 👇",
    "The best decision I made this month was joining Moneymate9ja 💚 Click the link below to join.",
    "Moneymate9ja paid me ₦600K after staying active consistently 🔥 Join now using the link below.",
    "My first withdrawal on Moneymate9ja was ₦200K 💸 Click the link below to start earning.",
    "I saw payment proofs on Moneymate9ja Telegram and joined immediately 😭 Click below to register.",
    "People are cashing out massively on Moneymate9ja every week 🔥 Join with the link below.",
    "Moneymate9ja users are really winning 💸 I’ve seen several ₦500K proofs. Click below to start.",
    "I thought the proofs were fake until I withdrew ₦240K myself 😭 Click the link below to join.",
    "Moneymate9ja paid my friend ₦320K this week 💚 Register now with the link below.",
    "If you’re still ignoring Moneymate9ja, you’re missing out 💸 Click below to start today.",
    "I’ve withdrawn more than once on Moneymate9ja already 🔥 Join now with the link below.",
    "Just got my ₦700K withdrawal approved on Moneymate9ja 😭💚 Click below to register.",
    "Moneymate9ja Telegram is full of payment proofs every Saturday 🔥 Click the link below to join.",
    "Users are cashing out ₦200K to ₦800K weekly on Moneymate9ja 💸 Register below and thank me later.",
    "I joined with doubts but Moneymate9ja surprised me with ₦260K withdrawal. Click below to start.",
    "Moneymate9ja paid me faster than I expected 💚 Join now with the link below.",
    "I withdrew ₦380K from Moneymate9ja simply by staying active daily. Register below 👇",
    "Moneymate9ja is one of the few platforms still paying users consistently 🔥 Click the link below to join now.",
    "I’ve seen over 10 payment proofs today alone on Moneymate9ja Telegram 👀 Register with the link below.",
    "My ₦200K withdrawal landed successfully today 💸 Click the link below to start.",
    "Moneymate9ja is not noise 😭 users are really cashing out. Join now with the link below.",
    "Last week I withdrew ₦420K from Moneymate9ja 💚 Click below to register and thank me later.",
    "My referral earnings plus task earnings got me ₦500K on Moneymate9ja 🔥 Click the link below to start.",
    "Moneymate9ja users are smiling every Saturday 💸 Join now with the link below.",
    "I finally achieved my first ₦300K withdrawal on Moneymate9ja 🔥 Register below 👇",
    "Moneymate9ja paid my roommate ₦210K this week 😭 Click the link below to join.",
    "I saw a ₦750K payment proof on Moneymate9ja Telegram today 👀 Register with the link below.",
    "Moneymate9ja users are cashing out heavily this month 💚 Click below to start earning.",
    "I never expected to earn ₦250K online this fast 😭 Join now using the link below.",
    "Moneymate9ja made online earning easier for me 💸 Click the link below to register.",
    "Just received another withdrawal alert from Moneymate9ja 🔥 Start now with the link below.",
    "My first cashout on Moneymate9ja was ₦230K 💚 Click below to join.",
    "Moneymate9ja has been trending because users are actually getting paid 💸 Register below 👇",
    "I’ve seen too many proofs on Moneymate9ja Telegram to ignore 😭 Click the link below to start.",
    "Moneymate9ja paid me ₦340K after completing tasks consistently 🔥 Join now with the link below.",
    "Another successful withdrawal on Moneymate9ja 💚 Register below and thank me later.",
    "I finally joined Moneymate9ja and I understand the hype now 🔥 Click below to start.",
    "My ₦280K withdrawal from Moneymate9ja came through successfully 💸 Join now with the link below.",
    "Moneymate9ja users are enjoying massive withdrawals lately 👀 Click the link below to register.",
    "I saw a ₦600K proof on Moneymate9ja Telegram this morning 🔥 Start with the link below.",
    "Moneymate9ja really surprised me with my first ₦200K withdrawal 💚 Join below 👇",
    "I completed tasks daily and withdrew ₦360K 💸 Click the link below to join.",
    "Moneymate9ja users are not joking with this earning opportunity 😭 Register below now.",
    "I joined Moneymate9ja late but still managed to withdraw ₦250K 🔥 Click the link below to start.",
    "Payment proofs everywhere 😭 Moneymate9ja is active. Join now using the link below.",
    "Moneymate9ja paid me ₦450K and I’m still shocked 💚 Click below to register.",
    "I saw people withdrawing ₦500K+ on Moneymate9ja Telegram 👀 Join with the link below.",
    "My Moneymate9ja withdrawal came in successfully today 🔥 Register now with the link below.",
    "Moneymate9ja users are earning serious money weekly 💸 Click below to start today.",
    "I withdrew ₦240K on Moneymate9ja just by staying consistent 💚 Join now with the link below.",
    "Moneymate9ja has been paying users massively this month 🔥 Click the link below to register.",
    "I can’t believe I finally withdrew ₦300K online 😭 Start earning with the link below.",
    "Moneymate9ja Telegram proofs convinced me to join 🔥 Click below to register now.",
    "Another Saturday, another set of huge Moneymate9ja withdrawals 💸 Join below 👇",
    "I withdrew ₦800K on Moneymate9ja and I’m grateful 💚 Click the link below to start.",
    "Moneymate9ja users are really cashing out nonstop 😭 Register with the link below.",
    "I’ve withdrawn more than ₦500K total from Moneymate9ja 🔥 Join now using the link below.",
    "Moneymate9ja paid me successfully today 💸 Click below to register.",
    "I saw multiple ₦200K+ payment proofs on Moneymate9ja Telegram 👀 Join with the link below.",
    "My task earnings on Moneymate9ja finally paid off 💚 Click below to start.",
    "I withdrew ₦270K this week from Moneymate9ja 🔥 Register now with the link below.",
    "Moneymate9ja users are smiling financially 😭 Click below to join today.",
    "Just saw another huge proof on Moneymate9ja Telegram 👀 Start with the link below.",
    "Moneymate9ja made me my first ₦400K online 💸 Join now with the link below.",
    "My withdrawal alert from Moneymate9ja entered this morning 💚 Click below to register.",
    "Moneymate9ja has been paying consistently every week 🔥 Join below 👇",
    "I withdrew ₦230K and referred my friends immediately 😭 Click the link below to start.",
    "Moneymate9ja users are cashing out real money 💸 Register now using the link below.",
    "I saw a ₦520K proof on Moneymate9ja Telegram today 🔥 Click below to join.",
    "Moneymate9ja paid my cousin ₦300K last week 💚 Register with the link below.",
    "I didn’t expect my first withdrawal to be ₦350K 😭 Start now with the link below.",
    "Moneymate9ja is really blessing users financially 💸 Click below to register.",
    "I’ve seen too many payment screenshots to doubt Moneymate9ja 🔥 Join now with the link below.",
    "Moneymate9ja paid me ₦200K without stress 💚 Click below to start earning.",
    "Another successful withdrawal alert from Moneymate9ja 🔥 Register now below.",
    "I saw users withdrawing ₦700K on Moneymate9ja Telegram 👀 Click below to join.",
    "Moneymate9ja is making many users financially active 💸 Start with the link below.",
    "I withdrew ₦260K on Moneymate9ja after completing tasks daily 💸 Click the link below to start.",
    "Moneymate9ja users are really winning this season 🔥 Register now with the link below.",
    "I saw over 10 payment proofs on Moneymate9ja Telegram today 😭 Click below to join.",
    "Moneymate9ja gave me my first ₦500K withdrawal 💚 Start now using the link below.",
    "My Moneymate9ja withdrawal came earlier than expected 💸 Click the link below to register.",
    "Moneymate9ja paid my friend ₦220K yesterday 🔥 Join below 👇",
    "I joined Moneymate9ja and withdrew within weeks 💚 Click below to start earning.",
    "Moneymate9ja users are earning massively from referrals and tasks 💸 Register now with the link below.",
    "Just received my ₦300K withdrawal successfully 😭 Click below to join today.",
    "Moneymate9ja Telegram is full of payment alerts 🔥 Start now with the link below.",
    "I withdrew ₦250K and immediately told my friends about Moneymate9ja 💚 Click the link below to register.",
    "Moneymate9ja paid me twice already 💸 Join below 👇",
    "I finally joined Moneymate9ja after seeing many proofs 👀 Click the link below to start.",
    "Moneymate9ja users are withdrawing daily 🔥 Register now using the link below.",
    "My first Moneymate9ja cashout changed my mindset 💚 Click below to join.",
    "I saw a ₦650K proof on Moneymate9ja Telegram 😭 Start now with the link below.",
    "Moneymate9ja paid my ₦280K withdrawal successfully 💸 Click below to register.",
    "Another happy user on Moneymate9ja 🔥 Join with the link below.",
    "Moneymate9ja users are really cashing out every Saturday 💚 Click below to start earning.",
    "I withdrew ₦200K faster than I imagined 😭 Register now with the link below.",
    "Moneymate9ja has been paying consistently this year 💸 Click below to join.",
    "I saw someone withdraw ₦800K on Moneymate9ja Telegram 👀 Start now using the link below.",
    "Moneymate9ja made online earning easier for me 🔥 Click below to register.",
    "My withdrawal alert from Moneymate9ja finally arrived 💚 Join now with the link below.",
    "I’ve withdrawn multiple times already on Moneymate9ja 💸 Click the link below to start.",
    "Moneymate9ja users are making serious money weekly 😭 Register below 👇",
    "I saw payment proofs all over Moneymate9ja Telegram today 🔥 Click below to join.",
    "Moneymate9ja paid me ₦330K successfully 💚 Start now with the link below.",
    "My friend joined Moneymate9ja and withdrew ₦240K 💸 Click below to register.",
    "Moneymate9ja users are enjoying massive payouts 🔥 Join now using the link below.",
    "I withdrew ₦370K on Moneymate9ja recently 💚 Click below to start.",
    "Moneymate9ja Telegram proofs convinced me completely 💸 Register now with the link below.",
    "My Moneymate9ja withdrawal landed this morning 😭 Click below to join.",
    "Moneymate9ja users are really active financially 🔥 Start now using the link below.",
    "I finally achieved my first ₦200K withdrawal 💚 Click below to register.",
    "Moneymate9ja paid my referral earnings successfully 💸 Join with the link below.",
    "I saw huge payment proofs on Moneymate9ja Telegram today 👀 Click below to start.",
    "Moneymate9ja is becoming one of my favorite earning platforms 🔥 Register now with the link below.",
    "I withdrew ₦410K this month from Moneymate9ja 💚 Click below to join.",
    "Moneymate9ja users are smiling to the bank 💸 Start now using the link below.",
    "I joined Moneymate9ja after seeing many successful withdrawals 😭 Click below to register.",
    "Moneymate9ja paid me ₦290K successfully 🔥 Join now with the link below.",
    "Another successful Saturday withdrawal on Moneymate9ja 💚 Click below to start earning.",
    "Moneymate9ja users are really getting paid weekly 💸 Register below 👇",
    "I saw multiple ₦300K+ proofs on Moneymate9ja Telegram 👀 Click the link below to join.",
    "Moneymate9ja paid me more than I expected 🔥 Start now using the link below.",
    "My first withdrawal on Moneymate9ja was successful 💚 Click below to register.",
    "Moneymate9ja users are cashing out without stress 💸 Join now with the link below.",
    "I withdrew ₦520K after staying active consistently 😭 Click below to start.",
    "Moneymate9ja Telegram is always active with proofs 🔥 Register now using the link below.",
    "Moneymate9ja paid my ₦200K withdrawal this week 💚 Click below to join.",
    "I saw a ₦780K payment proof on Moneymate9ja Telegram 👀 Start now with the link below.",
    "Moneymate9ja users are earning daily from tasks 💸 Click below to register.",
    "My withdrawal alert entered successfully from Moneymate9ja 🔥 Join now with the link below.",
    "Moneymate9ja is changing lives financially 💚 Click below to start earning.",
    "I withdrew ₦340K from Moneymate9ja this month 😭 Register now with the link below.",
    "Moneymate9ja users are really winning big 💸 Click below to join today.",
    "I saw many successful payment screenshots today on Moneymate9ja Telegram 🔥 Start now with the link below.",
    "Moneymate9ja paid me successfully again 💚 Click below to register.",
    "Join Moneymate9ja today and stand a chance to be among the next successful withdrawals 💸 Click the link below to start.",
  ];
  ...
  return (
    <div className="hh-root min-h-screen pb-28 relative overflow-hidden">
      ...
      <div className="max-w-md mx-auto px-4 space-y-4 pt-2 relative z-10 pb-6">
        {/* Hero Card — first thing on the page. */}
        ...
        <div className="hh-card hh-card-hero hh-entry-1 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            {/* Referral withdraw — airtime or cash, min ₦10,000 (20 referrals) */}
            {(() => {
              const min = REFERRAL_MIN_WITHDRAW;
              ...
              const withdrawAmount = avail;
              const displayAvail = avail;
              const canWithdraw = hasEarnings && avail >= min && !cashBusy;
              const cashDisabled = !canWithdraw;
              const openAirPopup = () => {
                try {
              ...
              <>
                <div className="mt-3 rounded-2xl border border-white/10 bg-black/20 p-3">
                  <div className="mb-2">
                    ...
                    <div className="text-[11px] text-white/60">Available: <span className="text-emerald-300 font-black">₦{displayAvail.toLocaleString()}</span> • Min: ₦{min.toLocaleString()} (20 referrals)</div>
                  ...
                  <div className="fixed inset-0 bg-black/80 backdrop-blur-md flex items-center justify-center z-50 p-4" onClick={() => setShowWdConfirm(null)}>
                    <div className="hh-popup max-w-sm w-full mx-4" onClick={(e) => e.stopPropagation()}>
                      ...
                      <p className="text-xs text-white/70 text-center leading-relaxed mt-2">
                        After this withdrawal, the referrals will <span className="text-amber-300 font-black">disappear from your withdrawal count</span> and available balance. This cannot be undone.
                      </p>
        ...
        {showAirPopup && (() => {
          ...
          const apMin = REFERRAL_MIN_WITHDRAW;
          ...
          const apCan = apHasEarnings && apAvail >= apMin && apPhone.length === 11 && !apLoading;
          return (
            <div className="fixed inset-0 bg-black/80 backdrop-blur-md flex items-center justify-center z-50 p-4" onClick={() => { if (!apLoading) setShowAirPopup(false); }}>
              <div className="hh-popup max-w-sm w-full mx-4" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="text-xs text-white/60 mb-3">Amount: <span className="text-amber-300 font-black">₦{apAvail.toLocaleString()}</span> • min ₦10,000 (20 referrals)</div>
                {!apHasEarnings && <div className="text-[11px] text-amber-300/80 -mt-2 mb-3">No earnings yet — invite friends to unlock withdrawal.</div>}
                ...
                <button disabled={!apCan} onClick={async () => {
                  ...
                  {apLoading ? "Sending..." : `Withdraw ${apAvail.toLocaleString()} Airtime →`}
                </button>
  ...
  return (
    <div className="hh-card hh-entry-3 border-emerald-500/30 bg-gradient-to-br from-emerald-500/10 via-teal-500/10 to-amber-500/10">
      ...
      <div className="grid grid-cols-2 gap-2 mt-3">
        ...
        <button onClick={()=> { const msg = `Join Moneymate9ja and help me unlock Auto Tap ${plan.label}! ${autoLink}`; window.open(`https://wa.me/?text=${encodeURIComponent(msg)}`, "_self"); }} className="hh-share-btn hh-share-wa flex items-center justify-center gap-2 py-2.5 rounded-xl text-sm font-black"><Share2 className="h-4 w-4" /> Share</button>
      </div>
      {done >= need ? (
