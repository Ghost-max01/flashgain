      ...
      <div className="max-w-md mx-auto px-4 space-y-4 pt-2 relative z-10 pb-6">
        ...
        <div className="hh-card hh-card-hero hh-entry-1 relative overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="flex items-center justify-between mb-4"><div className="flex items-center gap-2"><div className="hh-icon-ring"><Users className="h-5 w-5 text-emerald-300" /></div><span className="text-xs font-black tracking-widest text-emerald-300">TIERED REFERRAL — {plan.need} REQUIRED</span></div><div className="hh-live-indicator"><span className="hh-live-dot"></span><span className="text-xs">Active</span></div></div>
